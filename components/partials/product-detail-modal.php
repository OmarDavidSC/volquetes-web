            ...
            <div class="modal-body p-0">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-7 product-detail-modal__content">
                        ...
                        <h3 id="productDetailTitle" class="product-detail-modal__title">HOWO T7H</h3>
                        <p id="productDetailSubtitle" class="product-detail-modal__subtitle">Volquete 6x4 para obra pesada</p>
